...
#? I might see some repeated logic in defining schema (i.e., they all have paper_title, paper_link, etc.) and in the loop to populate these objects - but do not separate into one file because it confuses the LLM
